...
public class BooksTest {
    ...
    @Test(priority = 10,dataProviderClass = BookDataProvider.class, dataProvider = "addBookParameters")
    ...
    @Test(priority = 15,dataProviderClass = BookDataProvider.class, dataProvider = "deleteBookParameters")
    public void getBookbyId(int id){
        RequestTemplate.getRequest(MyConstants.url+"book/"+id);
        System.out.println("[TEST PASSED] Book " + id + " obtained successfully");
    }

    @Test(priority = 20,dataProviderClass = BookDataProvider.class, dataProvider = "updateBookParameters")
    ...
    @Test(priority = 25,dataProviderClass = BookDataProvider.class, dataProvider = "deleteBookParameters")
