...
public class PublisherTest {
    ...
    public void createPublisher(String bodyContent) {
        ...
        System.out.println("Publisher " + PublisherDataProvider.addPublisher(response) + " added successfully");
    }

    @Test(priority = 200)
    public void getAll() {
        RequestTemplate.getRequest(MyConstants.url+path);
        System.out.println("All publishers obtained successfully");
    }
    ...
    public void getPublisher(int id) {
        ...
        System.out.println("Publisher " + id + " obtained successfully");
    }
    ...
    public void updatePublisher(int id, String bodyContent) {
        ...
        System.out.println("Publisher " + id + " updated successfully");
    }
    ...
    public void deletePublisher(int id) {
        ...
        System.out.println("Publisher " + id + " deleted successfully");
    }
}
